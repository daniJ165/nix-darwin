  ...
  config = lib.mkIf (pkgs.stdenv.isDarwin) {
    ...
    home.file.".aerospace.toml".text = ''
      ...
      after-startup-command = [
        'exec-and-forget ${pkgs.jankyborders}/bin/borders active_color=0xff99ccff inactive_color=0xffb399ff width=1.0'
	]
      ...
      alt-shift-b = 'exec-and-forget open -a "zen-browser"'
      alt-shift-t = 'exec-and-forget open -a "kitty"'
      alt-shift-f = 'exec-and-forget open -a "signal"'
